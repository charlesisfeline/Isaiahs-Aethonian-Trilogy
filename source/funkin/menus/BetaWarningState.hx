...
class BetaWarningState extends MusicBeatState {
	...
	public override function create() {
		...
		disclaimer.applyMarkup('This is a sub-engine of Codename Engine. That means it still has *majority of the features* are either *buggy* or *non finished*. If you find any bugs, please report them to the Codename Engine Official GitHub.\n\nPress ENTER to continue',
			[
